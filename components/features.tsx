      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {features.map((feature) => (
            <div
              key={feature.number}
              className="relative bg-gradient-to-b from-[#111827] to-[#0B1221] rounded-xl p-4 md:p-6 group hover:bg-gradient-to-b hover:from-[#132338] hover:to-[#0B1221] transition-all duration-300"
            >
              <div className="flex flex-col space-y-3 md:space-y-4">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#40C057]/10 rounded-lg flex items-center justify-center">
                  <feature.icon className="w-5 h-5 md:w-6 md:h-6 text-[#40C057]" />
                </div>
                ...
                <div className="absolute top-4 md:top-6 right-4 md:right-6 text-[#40C057] opacity-50 font-bold text-sm md:text-base">
                  {feature.number}
                </div>
              </div>
            </div>
